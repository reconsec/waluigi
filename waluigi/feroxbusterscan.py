...
class FeroxScope(luigi.ExternalTask):
    ...
    def output(self):
        ...
        # path to input file
        http_inputs_file = dir_path + os.path.sep + "ferox" + scan_id
...
class FeroxScan(luigi.Task):
    ...
    def output(self):
        ...
        # path to input file
        http_outputs_file = dir_path + os.path.sep + "ferox_outputs_" + scan_id
    ...
    def run(self):
        ...
        if len(http_scan_data) > 0:
            ...
            for port_str in port_ip_dict:
                ...
                scan_output_file_path = output_dir + os.path.sep + "ferox_out_" + port_str
                ...
                # Write ips to file
                scan_input_file_path = output_dir + os.path.sep + "ferox_in_" + port_str
